    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
      ...
      <div className="w-full md:w-1/2 flex justify-center items-center px-6 sm:px-10 lg:px-20 py-10">
        <div className="w-full max-w-md">
          ...
          <div className="mb-4">
            <button className="bg-red-500 py-2 p-4 rounded-full text-white cursor-pointer">Admin</button>
            <button className="bg-red-500 py-2 p-4 rounded-full text-white ml-4 cursor-pointer">User</button>
          </div>
